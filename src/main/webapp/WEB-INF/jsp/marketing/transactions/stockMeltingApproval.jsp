...
<div class="panel panel-primary">
	...
	<label class="col-lg-5 text-left">
				<span style="font-size: 18px;">Stock Melting Pending Approval Details</span>
			</label>
			</div>
			
			<div class="text-right">
		<a class="btn btn-xs btn-info" id="trfBtnId" style="font-size: 14px" type="button" onclick="javascript:popStockMeltingApproval()"><b>Approval</b></a>
		</div>	
	...
	<div class="panel-body">
			...
			<div class="row">
				...
				<div class="table-responsive">
 					<table id="stockMeltApprovalTblId" data-toggle="table" data-search="true" data-toolbar="toolbarDt" data-maintain-meta-data="true" data-height="450"  >
					<thead>
			...
			<div id="odImgDivId" class="col-md-2 center-block">
					...
					<div class="panel panel-primary" style="width:100%; height:245px">
						...
						<div class="form-group">
							<div>
								<input type="button" value="Approval" onclick="javascript:popStockMeltingApproval()" id="trfBtnId" class="btn btn-primary">
							</div>
						</div>
...
function popBagDt(){
				...
				$("#stockMeltApprovalTblId")
				.bootstrapTable(
						'refresh',
						{
							url : "/jewels/marketing/transactions/stockMeltingApproval/listing.html?approvalFlg=true",
						}); 
	
} 

$('#stockMeltApprovalTblId').on('check.bs.table', function (e, row) {
...
$('#stockMeltApprovalTblId').on('check-all.bs.table', function (e, row) {
...
$('#stockMeltApprovalTblId').on('uncheck.bs.table', function (e, row) {
...
$('#stockMeltApprovalTblId').on('uncheck-all.bs.table', function (e, row) {
...
$('#stockMeltApprovalTblId').bootstrapTable({}).on(
		'load-success.bs.table',
		function(e, data) {
			var data = JSON.stringify($("#stockMeltApprovalTblId").bootstrapTable('getData'));
			var vBagPcs = 0.0;
			var vWt = 0.0;
			var i=0;
...
function popSelectedQty(){
	...
	var data = $('#stockMeltApprovalTblId').bootstrapTable('getAllSelections');
...
function popStockMeltingApproval(){
	...
	$.ajax({
		url : "/jewels/marketing/transactions/stockMeltingApproval/save.html?vDtId="+$('#vDtId').val(),
