...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/saleMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/saleMt/listing.html"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/saleMt/delete/" + mtId + ".html",
		type : 'GET',
