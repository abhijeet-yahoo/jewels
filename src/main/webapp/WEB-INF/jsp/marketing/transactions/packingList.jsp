...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/packList/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/packList/listing.html"
...
function deleteMt(mtId){
	...
	$("#modalDialog").modal("hide");
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/packList/delete/"+ mtId + ".html",
		type : 'GET',
...
function deletePackList(e,mtId){
