...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/stockMeltingMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/stockMeltingMt/listing.html"
...
function deleteMt(mtId){
	...
	$("#modalDialog").modal("hide");
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/stockMeltingMt/delete/"+ mtId + ".html",
		type : 'GET',
...
function deleteStockMeltingMt(e,mtId){
