...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/consigRetMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/consigRetMt/listing.html"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/consigRetMt/delete/" + mtId + ".html",
		type : 'GET',
...
function deleteConsigRetMt(e,mtId){
