...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/saleRetMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/saleRetMt/listing.html"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/saleRetMt/delete/" + mtId + ".html",
		type : 'GET',
...
function deleteSaleRetMt(e,mtId){
