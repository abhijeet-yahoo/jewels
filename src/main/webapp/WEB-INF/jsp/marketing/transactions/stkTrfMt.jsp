...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/marketing/transactions/stkTrfMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/marketing/transactions/stkTrfMt/listing.html?tranType=STOCKTRF"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/marketing/transactions/stkTrfMt/delete/" + mtId + ".html?tranType=STOCKTRF",
		type : 'GET',
