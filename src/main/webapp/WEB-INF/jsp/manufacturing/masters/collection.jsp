...
<c:set var="option" value="Collection" />
 ...
 <c:if test="${success eq true}">
		...
		<c:choose>
			<c:when test="${canAdd}">
				<a class="btn btn-info" style="font-size: 15px" type="button"
					href="/jewels/manufacturing/masters/collection/add.html"><span
					class="glyphicon glyphicon-plus"></span>&nbsp;Add Collection</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-info" style="font-size: 15px" type="button"
	...
	<div>
		<table data-toggle="table"
			data-url="/jewels/manufacturing/masters/collection/listing.html?opt=1"
			...
			<thead>
				<tr class="btn-primary">
					...
					<th data-field="collectionCode" data-align="left" data-sortable="true">Code</th>
