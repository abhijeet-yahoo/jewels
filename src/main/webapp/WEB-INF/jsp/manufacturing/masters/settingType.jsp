...
<c:set var="option" value="SettingType" />

<c:if test="${success eq true}">
		<div class="alert alert-success">SettingType ${action} successfully!</div>
</c:if>
...
<div>
		...
		<c:choose>
			<c:when test="${canAdd}">
				<a class="btn btn-info" style="font-size: 15px" type="button"
					href="/jewels/manufacturing/masters/settingType/add.html"><span
					class="glyphicon glyphicon-plus"></span>&nbsp;Add Setting Type</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-info" style="font-size: 15px" type="button"
	...
	<!-- 	<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/masters/settingType/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;Add SettingType</a> -->
	</div>
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/masters/settingType/listing.html?opt=1"
