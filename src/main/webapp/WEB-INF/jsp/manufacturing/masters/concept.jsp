...
<c:set var="option" value="Concept" />
...
<div>
		...
		<c:choose>
			<c:when test="${canAdd}">
				<a class="btn btn-info" style="font-size: 15px" type="button"
					href="/jewels/manufacturing/masters/concept/add.html"><span
					class="glyphicon glyphicon-plus"></span>&nbsp;Add Concept</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-info" style="font-size: 15px" type="button"
	...
	<div>
		<table data-toggle="table"
			data-url="/jewels/manufacturing/masters/concept/listing.html?opt=1"
