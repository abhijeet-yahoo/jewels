...
<div class="panel panel-primary" style="width: 100%">
	<div class="panel-heading" id="tabdiv">
		<span style="font-size: 18px;margin-right:62em;">Labour Charge</span>
	</div>
	
	
	<form:form commandName="labourCharge"
		action="/jewels/manufacturing/masters/labourCharge/add.html"
		...
		<c:if test="${param.success eq true}">
			...
			<div class="alert alert-success">Labour Charge  ${param.action} successfully!</div>
		</c:if>
		<div class="row">
			<div class="col-xs-12">&nbsp;</div>
        </div>	
	  <div class="form-group">
		...
		<div class="form-group">
			<label for="name" class="col-sm-2 control-label">Category <span style="color: red;">*</span></label>
			<div class="col-sm-5">
	   ...
	   <div class="form-group">
			...
			<div class="form-group">
	   		<div class="col-sm-1"></div>
	   			<div class="col-sm-2">
					<label> <form:checkbox path="defLabour" /> <b>Default Labour</b></label>
				</div>
			...
			<div class="form-group">
				...
				<c:if test="${canAdd || canEdit}">
					...
					<a id="listingId"
						...
						href="/jewels/manufacturing/masters/labourCharge.html">Labour Charge Listing</a>
			...
			$
					.ajax({
						...
						success : function(data, textStatus, jqXHR) {	
							if(data === '-1'){
								displayMsg(this, null, 'Party, Category and LabourType exists');
							}else if(data === '-2'){
