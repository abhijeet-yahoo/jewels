...
<c:set var="option" value="DesignGroup" />
...
<div>
	<div id="toolbar">
		...
		<c:choose>
			...
			href="/jewels/manufacturing/masters/designGroup/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;Add DesignGroup</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-info" style="font-size: 15px" type="button"
	...
	<div>
		<table  data-toggle="table" data-url="/jewels/manufacturing/masters/designGroup/listing.html?opt=1"
