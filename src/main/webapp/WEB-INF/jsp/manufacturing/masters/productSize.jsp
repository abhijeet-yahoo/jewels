...
<div class="panel panel-primary" style="width: 100%">
	<c:set var="option" value="Product Size" />
		...
		<div class="col-xs-12">
			...
			<div class="col-xs-12">
				<div>
					<div id="toolbar">
						<c:if test="${canAdd}">
							<a class="btn btn-info" style="font-size: 15px" type="button"
								href="/jewels/manufacturing/masters/productSize/add.html"><span
								class="glyphicon glyphicon-plus"></span>&nbsp;Add Product Size</a>
						</c:if>
						<c:if test="${!canAdd}">
							<a class="btn btn-info" style="font-size: 15px" type="button"
					...
					<div>
						<table id="sizeId" data-toggle="table"
							data-url="/jewels/manufacturing/masters/productSize/listing.html"
							data-toolbar="#toolbar" data-pagination="true" data-show-export="true"
							data-side-pagination="server"
							data-page-list="[10, 20, 50, 100, 200,1000]" data-search="true"
							data-striped="true" data-height="550">
							<thead>
								<tr class="btn-primary">
									<th data-field="categName" data-align="left" data-sortable="true">Category</th>
									<th data-field="name" data-align="left" data-sortable="true">Product Size</th>
								...
								<!-- 	<th data-field="deactiveDt" data-sortable="true">DeactiveDate</th> -->
	...
	function getChild(id) {
		$("#sizeId")
				.bootstrapTable(
						'refresh',
						{
							url : "/jewels/manufacturing/masters/productSize/listing.html?id="
									+ id
						});
