...
<div class="panel panel-primary">
	...
	<div class="panel-heading" id="barcodeDivId">
		<span style="font-size: 18px;">Pending Approval Details</span>
	</div>
	...
	<div class="panel-body">
		...
		<input type="hidden" name="vFgIssDtIds" id="vFgIssDtIds" />
	</div>		
...
function popBagDt(){
				...
				.bootstrapTable(
						'refresh',
						{
							url : "/jewels/manufacturing/transactions/fgIssMt/appListing.html"
						}); 
...
function popApproveFg(){
	...
	var ids = $.map(data, function(item) {
		return item.fgIssDtId;
	});
	$('#vFgIssDtIds').val(ids);
	
	
	$.ajax({
		url : "/jewels/manufacturing/transactions/fgIssApprove.html?vFgIssDtIds="+$('#vFgIssDtIds').val(),
