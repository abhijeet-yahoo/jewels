...
<c:set var="option" value="CompInwardDt" />

<div class="container">
	<div id="toolbar">
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/compInwardDt/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;Add CompInwardDt</a>
	</div>
	<div>
		<table data-toggle="table"
			data-url="/jewels/manufacturing/transactions/compInwardDt/listing.html"
