...
<div class="form-group">
	<div class="form-group">
		<form:form commandName="stoneInwardDt" id="stoneInwardDtt"
			action="/jewels/manufacturing/transactions/stoneInwardDt/add.html"
			cssClass="form-horizontal stoneInwardDttForm">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="col-lg-2 col-sm-2">
						<form:input path="diffCarat" cssClass="form-control" onchange="javascript:setAmount()"/>
					</div>
					<div class="col-lg-2 col-sm-2">
			...
			<div class="form-group">
				<div class="col-sm-5">
					...
					<form:input type="hidden" id="stoneInwardDtEntryId" path="id" />
