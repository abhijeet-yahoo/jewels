...
<c:set var="option" value="CompOutwardMt" />

<c:if test="${success eq true}">
		<div class="alert alert-success">CompOutwardMt ${action} successfully!</div>
</c:if>
...
<div>
		...
		<c:choose>
			<c:when test="${canAdd}">
				...
				href="/jewels/manufacturing/transactions/compOutwardMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/compOutwardMt/listing.html"
