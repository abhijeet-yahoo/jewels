...
<div class="container">
	<div id="toolbar">
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/metalInwardDt/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;Add MetalInwardDt</a>
	</div>
	<div>
		<table data-toggle="table"
			data-url="/jewels/manufacturing/transactions/metalInwardDt/listing.html"
