...
<div class="panel panel-primary" style="width: 100%">
	<div class="panel-heading">
		<span style="font-size: 18px;">Metal Deduction</span>
	</div>
			...
			<div class="form-group">
				<div class="form-group">
					<form:form commandName="metalTran" id="metalDeductionEntry"
						action="/jewels/manufacturing/transactions/metalDeduction/add.html"
	...
	function popMetalDeductionTable() {
		...
		$("#metalDeductionTableId")
				.bootstrapTable(
						'refresh',
						{
							url : "/jewels/manufacturing/transactions/metalDeduction/listing.html?BagNo="
									+ $('#bagMt\\.name').val()
						});
	}
	...
	function goToMetalDeductionEntry() {
		 ...
		 if (! $('#bagMt\\.name').val()) {
			...
			if( $('#bagMt\\.name').val() != null && ! $('#orderMt\\.invNo').val()) {
				...
				var validator = $( "#mDeductionEntry" ).validate();
				validator.resetForm();
				$( 'form#metalDeductionEntry input[type="text"],textarea, select').val('');
				$('form#metalDeductionEntry select').val('');
