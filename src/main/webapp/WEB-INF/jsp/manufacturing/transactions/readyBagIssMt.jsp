...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/readyBagIssMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/readyBagIssMt/listing.html"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/readyBagIssMt/delete/" + mtId + ".html",
		type : 'GET',
...
function deleteReadyBagIssMt(e,mtId){
