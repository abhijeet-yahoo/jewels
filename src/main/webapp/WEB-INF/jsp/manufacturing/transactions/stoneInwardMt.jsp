...
<c:set var="option" value="StoneInwardMt" />

<c:if test="${success eq true}">
		<div class="alert alert-success">StoneInwardMt ${action} successfully!</div>
</c:if>
...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/stoneInwardMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/stoneInwardMt/listing.html"
...
function deleteMt(mtId){
	...
	$("#modalDialog").modal("hide");
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/stoneInwardMt/delete/"+ mtId + ".html",
		type : 'GET',
