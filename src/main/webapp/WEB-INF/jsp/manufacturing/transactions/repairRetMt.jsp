...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/repairRetMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/repairRetMt/listing.html"
...
function deleteMt(mtId){
	...
	$("#modalDialog").modal("hide");
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/repairRetMt/delete/"+ mtId + ".html",
		type : 'GET',
...
function deleteRepairRetMt(e,mtId){
