...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/readyBagRetMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/readyBagRetMt/listing.html"
...
function deleteMt(mtId){
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/readyBagRetMt/delete/" + mtId + ".html",
		type : 'GET',
...
function deleteReadyBagRetMt(e,mtId){
