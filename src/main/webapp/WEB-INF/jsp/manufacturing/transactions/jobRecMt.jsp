...
<c:set var="option" value="jobRecMt" />
...
<div>
	<div id="toolbar">
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/jobRecMt/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;New</a>
	</div>
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/jobRecMt/listing.html"
...
function deleteJobData(id){
	...
	$.ajax({
		url : "/jewels/manufacturing/transactions/jobRecMt/delete/"+id+".html",
		type : 'GET',
