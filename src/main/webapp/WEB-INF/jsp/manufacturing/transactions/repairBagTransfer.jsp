...
<div class="panel panel-primary">
	...
	<label class="col-lg-5 text-left">
				<span style="font-size: 18px;">Repair Details</span>
			</label>
		...
		<a class="btn btn-xs btn-info" id="repairIssBackBtnId" style="font-size: 14px" type="button" onclick="javascript:repairIssBackBtn()"><b>Back</b></a>
		</div>	
...
.ready(
		function(e) {
		 	...
		 	if (window.location.href.indexOf('mtid') != -1) {
						...
						repairMtId = vUrl.substring(window.location.href.indexOf('mtid') + 5);
...
function popBagDt(){
				...
				.bootstrapTable(
						'refresh',
						{
							url : "/jewels/manufacturing/transactions/repairTransfer/listing.html?departmentId="
								+ '${deptId}',
						}); 
...
function popTrfStk(){
	...
	$.ajax({
		url : "/jewels/manufacturing/transactions/repairTransferInStock.html?vMtId="+$('#vMtId').val()+"&repairIssMtId="+repairMtId,
...
function repairIssBackBtn(){
	

		window.location.href = "/jewels/manufacturing/transactions/repairIssMt/edit/"+repairMtId+".html"
