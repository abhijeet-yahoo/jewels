...
<c:set var="option" value="MetalOutwardMt" />
...
<div>
	<div id="toolbar">
		<c:choose>
			...
			href="/jewels/manufacturing/transactions/metalOutwardMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/metalOutwardMt/listing.html"
