	...
	<div class="form-group">
		<form:form commandName="readyBag"
			...
			<div class="col-xs-12">
				...
				<div class="col-sm-4">
				<div class="form-group">
					<label class="col-sm-4 text-right">Location :</label>
					<div class="col-sm-7">
						<form:select path="location.id" class="form-control"  onChange="javascript:popDeptTo();">
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<!-- <td class="col-lg-6 col-sm-6" id="updGId">
							<div class="checkbox">
		 ...
		 if(!! $("#bagMt\\.name").val().trim()){
						 ...
						 $("#readyBagId")
							.bootstrapTable(
									'refresh',
									{
										url : "/jewels/manufacturing/transactions/readyBag/listing.html?pBagNm="+ $("#bagMt\\.name").val()+"&locationId="
										+ $('#location\\.id').val(),
									});
