...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/barcodeMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/barcodeMt/listing.html"
...
function deleteBarcodeMt(mtId){
	
	$("#modalDialog").modal("hide");

	 $.ajax({
		url : "/jewels/manufacturing/transactions/barcodeMt/delete/"+ mtId + ".html",
		type : 'GET',
 ...
 function deleteBarcode(e,mtId){

	 displayDlg( e, 'javascript:deleteBarcodeMt('+mtId+');', 'Delete', 'Do you want to Delete  ?', 'Continue');
