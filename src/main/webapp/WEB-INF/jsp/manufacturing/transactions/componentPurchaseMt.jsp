...
<c:set var="option" value="componentPurchaseMt" />
...
<div>
	...
	<div id="toolbar">
		<c:choose>
			...
			href="/jewels/manufacturing/transactions/componentPurchaseMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/componentPurchaseMt/listing.html"
...
function deleteComponentMtPurchaseMt(e,mtId){
		
		displayDlg(
				e,
				'javascript:deleteComponentMtPurchaseMtData('+mtId+');',
				'Delete',
				'Do you want to Delete  ?',
				'Continue');
	}

	function deleteComponentMtPurchaseMtData(mtId){
		
		$("#modalDialog").modal("hide");
				
		$.ajax({
			
			url:'/jewels/manufacturing/transactions/componentPurchaseMt/delete/'+mtId+'.html',
			data: 'GET',
