...
<c:set var="option" value="StoneOutwardDt" />

<div class="container">
	<div id="toolbar">
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/stoneOutwardDt/add.html"><span
			class="glyphicon glyphicon-plus"></span>&nbsp;Add StoneOutwardDt</a>
	</div>
	<div>
		<table data-toggle="table"
			data-url="/jewels/manufacturing/transactions/stoneOutwardDt/listing.html"
			...
			<thead>
				<tr  class="btn-primary">
					...
					<th data-field="sizeGroupStr" data-sortable="true">SizeGroup</th>
