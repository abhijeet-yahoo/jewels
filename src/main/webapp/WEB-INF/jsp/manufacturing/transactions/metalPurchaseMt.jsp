...
<c:set var="option" value="metalPurchaseMt" />

<c:if test="${success eq true}">
		<div class="alert alert-success">Metal Purchase ${action} successfully!</div>
</c:if>
...
<div>
	<div id="toolbar">
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/metalPurchaseMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/metalPurchaseMt/listing.html"
			...
			<thead>
				<tr>
					...
					<th data-field="dueDate" data-align="left" data-sortable="true">Due Date</th>
