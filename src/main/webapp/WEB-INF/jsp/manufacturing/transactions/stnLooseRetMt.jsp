...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/stnLooseRetMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/stnLooseRetMt/listing.html"
...
function deleteRetMt(mtId){
	...
	$.blockUI({ message: '<h1><img src="/jewels/uploads/manufacturing/imgLoad.gif" /> Please Wait...</h1>' });
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/stnLooseRetMt/delete/"+ mtId + ".html",
		type : 'GET',
...
function deleteStnLooseRetMt(e,mtId){

		displayDlg(
				e,
				'javascript:deleteRetMt('+mtId+');',
				'Delete',
