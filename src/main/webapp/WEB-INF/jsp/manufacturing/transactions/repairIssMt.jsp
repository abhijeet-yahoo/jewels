...
<div>
	...
	<c:choose>
		...
		<a class="btn btn-info" style="font-size: 15px" type="button"
			href="/jewels/manufacturing/transactions/repairIssMt/add.html"><span
	...
	<div>
		<table data-toggle="table" data-url="/jewels/manufacturing/transactions/repairIssMt/listing.html"
...
function deleteMt(mtId){
	...
	$("#modalDialog").modal("hide");
	 ...
	 $.ajax({
		url : "/jewels/manufacturing/transactions/repairStockIss/delete/"+ mtId + ".html",
		type : 'GET',
...
function deleteRepairIss(e,mtId){
