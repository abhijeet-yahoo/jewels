	...
	<div class="panel-body">
				...
				<div class="container-fluid">
					<div class="row">
							...
							<div>
								<table id="costJobCompFindingId" data-toggle="table" data-toolbar="#toolbar"
				...
				<div id="rateUpdate" style="display: none">
					<div class="row">
						<div class="form-group">
							<div class="col-xs-12">
							<form:form commandName="costJobCompDt" >
			...
			<div class="row" >
				<div class="form-group">
					<div class="col-xs-1" >
						<form:form commandName="costJobCompDt" id="setJobFinding"
							action="/jewels/manufacturing/transactions/job/finding/setRate.html"
								...
								<tbody>
									<tr>
										<td class="col-xs-1" >
											...
											<input type="hidden" id="costingJobMtId" name="costingJobMtId" />
										</td>
										<td class="col-xs-1">
...
$(document).ready(function(){
  ...
  function popTable(){
	...
	$('#costJobCompFindingId').bootstrapTable(
				'refresh',{
	...
	$('#fldRate').on('blur', function(e) {
		$("#costJobCompFindingId").bootstrapTable('updateRow', {
			index : inwTblRow,
			row : {
				state : true,
				rate : $('#fldRate').val(),
	...
	on('submit',
		...
		var data = $("#costJobCompFindingId").bootstrapTable("getSelections");
