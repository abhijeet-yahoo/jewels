...
<style>
	...
	<div class="modal fade" id="myJobMtlIssDtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  >
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      
	      <div class="modal-header">
		       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> 
		      	<h4 class="modal-title" id="myModalLabel">Job Metal Issue Detail</h4>
	      </div>
	      
	      <div class="modal-body">
				
				<div class="form-group" id="jobMtlIssDtModalDivId">
				<form:form commandName="jobMtlIssDt" id="jobMtlIssDtFormId"
					action="/jewels/manufacturing/transactions/jobMtlIssDt/add.html"
					cssClass="form-horizontal jobMtlIssDtForm">
				...
				<%-- 	<div class="col-lg-3 col-sm-3">
					...
					<div class="row">
						<div class="col-lg-12">
							<form:input type="hidden" path="id" id="modalJobMtlIssDtId"/>
							<input type="hidden" id="vJobIssMtPkId" name="vJobIssMtPkId" />
	      ...
	      <div class="modal-footer">
	        	<input type="button" value="Save" class="btn btn-default" onclick="javascript:popJobMtlIssDtSave()" id="jobMtlIssBtnId"/>
	...
	function popJobMtlIssDtSave(){
		var postData = $("#jobMtlIssDtFormId").serializeArray();
	
		var formURL = $("#jobMtlIssDtFormId").attr("action");
		$('#jobMtlIssBtnId').attr('disabled', 'disabled');
		 if($(".jobMtlIssDtForm").valid()){
				...
				success : function(data, textStatus, jqXHR) {  
					...
					if(data === '1'){
						...
						popJobMtlIssDt();
						 ...
						 $('#jobMtlIssDtModalDivId input[type="text"],textarea').val('');
						 $('#jobMtlIssDtModalDivId input[type="number"]').val('0');
						 $('#jobMtlIssDtModalDivId').find('select').val('');
						 $('#modalJobMtlIssDtId').val('');
					
					}else if(data === '2'){
						 displayInfoMsg(this,null,"Record Updated Successfully !");
						 $('#myJobMtlIssDtModal').modal('hide');
						 popJobMtlIssDt();
					...
					$('#jobMtlIssBtnId').removeAttr('disabled');
