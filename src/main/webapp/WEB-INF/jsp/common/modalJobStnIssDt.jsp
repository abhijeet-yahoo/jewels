...
<style>
	...
	<div class="modal fade" id="myJobStnIssDtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  >
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      
	      <div class="modal-header">
		       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> 
		      	<h4 class="modal-title" id="myModalLabel">Job Stone Issue Detail</h4>
	      </div>
	      
	      <div class="modal-body">
				
				<div class="form-group" id="jobStnIssDtModalDivId">
				<form:form commandName="jobStnIssDt" id="jobStnIssDtFormId"
					action="/jewels/manufacturing/transactions/jobStnIssDt/add.html"
					cssClass="form-horizontal jobStnIssDtForm">
				...
				<div class="col-xs-12">
					...
					<div class="col-lg-3 col-sm-3">
						<!-- 	<input type="text" id="vSieve" name="vSieve" class="form-control" readonly="readonly" /> -->
							<form:input path="sieve" id="vSieve" cssClass="form-control" readonly="true" />
						</div>	
				...
				<div class="row">
					...
					<%-- <div class="col-lg-3 col-sm-3">
						<form:input path="stnRate" cssClass="form-control" onchange="javascript:setAmountStn()" />
						</div>			 --%>
					...
					<div class="row">
						<div class="col-lg-12">
							<form:input type="hidden" path="id" id="modalJobStnIssDtId"/>
							<input type="hidden" id="vJobStnIssMtId" name="vJobStnIssMtId" />
	      ...
	      <div class="modal-footer">
	        	<input type="button" value="Save" class="btn btn-default" onclick="javascript:popJobStnIssDtSave()" id="jobStnIssBtnId"/>
	...
	function popJobStnIssDtSave(){
		
		
		var postData = $("#jobStnIssDtFormId").serializeArray();
	
		var formURL = $("#jobStnIssDtFormId").attr("action");
		$('#jobStnIssBtnId').attr('disabled', 'disabled');
		
		 if($(".jobStnIssDtForm").valid()){
				...
				success : function(data, textStatus, jqXHR) {  
					...
					if(data === '1'){
						...
						popJobStnIssDt();
						 ...
						 $('#jobStnIssDtModalDivId input[type="text"],textarea').val('');
						 $('#jobStnIssDtModalDivId input[type="number"]').val('0');
						 $('#jobStnIssDtModalDivId').find('select').val('');
						 $('#modalJobStnIssDtId').val('');
					
					}else if(data === '2'){
						 displayInfoMsg(this,null,"Record Updated Successfully !");
						 $('#myJobStnIssDtModal').modal('hide');
						 popJobStnIssDt();
					...
					$('#jobStnIssBtnId').removeAttr('disabled');
	...
	function setAmountStn() {
		...
		var vCarat = $('#jobStnIssDtModalDivId #carat').val();
		var vrate = Number($('#jobStnIssDtModalDivId #stnRate').val());
		var vDiffCarat = $('#jobStnIssDtModalDivId #diffCarat').val();
		...
		$('#jobStnIssDtModalDivId #stnAmount').val(Number(vamount.toFixed(2)));
		$('#jobStnIssDtModalDivId #carat').val(vvCarat.toFixed(3));
		$('#jobStnIssDtModalDivId #stnRate').val(vvRate.toFixed(2));
		$('#jobStnIssDtModalDivId #diffCarat').val(dcarat.toFixed(3));
