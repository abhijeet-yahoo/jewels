...
<style>
    ...
    <div class="modal fade" id="myBagSearchModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  >
	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Bag Search</h4>
			</div>
			...
			<div class="modal-body">
					...
					<form:form commandName="bagMt">
						...
						<div class="col-xs-10">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="col-lg-3 col-sm-3">
										<form:input path="orderDt.orderMt.invNo"
				...
				<div class="col-lg-3 col-sm-3">
						<input type="text" name="vTotStone" id="vTotStone" class="form-control" disabled="true" />
					</div>
					<div class="col-lg-3 col-sm-3">
						<input type="text" name="vTotCarat" id="vTotCarat" class="form-control" disabled="true" />
					</div>
						...
						<div id="odImgDivId"
							class="col-lg-2 col-md-2 col-sm-6 col-xs-6 center-block">
							<div class="panel panel-primary" style="height: 130px">
								<div class="panel-body">
									<div style="width: 90px; height: 160px">
										<a id="oImgHRId"
...
.ready(
		function(e) {
			...
			if (window.location.href.indexOf('bagSearch') != -1) {
...
/* function goToTransferPage(){
	...
	window.location.href = "/jewels/manufacturing/transactions/transfer.html?%%&="+$('name').val();
