...
<style>
	...
	<!--------- ConsigRetRmMetalDt modal --------->
	
	<div class="modal fade" id="myConsigRetRmMetalDtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				...
				<div class="form-group" id="consigRetRmMetalDtModalDivId">
				<form:form commandName="consigRetRmMetalDt" id="consigRetRmMetalDtFormId"
					action="/jewels/marketing/transactions/consigRetRmMetalDt/add.html"
					cssClass="form-horizontal consigRetRmMetalDtForm">
				...
				<div class="col-lg-3 col-sm-3">
					...
					<div class="row">
						<div class="col-lg-12">
							<form:input type="hidden" path="id" id="modalConsigRetRmMetalDtId"/>
							<input type="hidden" id="vConsigRetMtId" name="vConsigRetMtId" />
	      ...
	      <div class="modal-footer">
	        	<input type="button" value="Save" class="btn btn-default" onclick="javascript:popConsigRetRmMetalDtSave()" id="consigRetRmMetalBtnId"/>
	...
	$(document).ready(function(e) {
		$(".consigRetRmMetalDtForm").validate({
			rules : {
				'metal.id' : {
					required : true,
				},
	...
	function popConsigRetRmMetalDtSave(){
		var postData = $("#consigRetRmMetalDtFormId").serializeArray();
	
		var formURL = $("#consigRetRmMetalDtFormId").attr("action");
		$('#consigRetRmMetalBtnId').attr('disabled', 'disabled');
		 if($(".consigRetRmMetalDtForm").valid()){
				...
				success : function(data, textStatus, jqXHR) {  
					...
					if(data === '1'){
						...
						popConsigRetRmMetalDt();
						 ...
						 $('#consigRetRmMetalDtModalDivId input[type="text"],textarea').val('');
						 $('#consigRetRmMetalDtModalDivId input[type="number"]').val('0');
						 $('#consigRetRmMetalDtModalDivId').find('select').val('');
						 $('#modalConsigRetRmMetalDtId').val('');
					
					}else if(data === '2'){
						 displayInfoMsg(this,null,"Record Updated Successfully !");
						 $('#myConsigRetRmMetalDtModal').modal('hide');
						 popConsigRetRmMetalDt();
					...
					$('#consigRetRmMetalBtnId').removeAttr('disabled');
