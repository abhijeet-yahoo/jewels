...
(function() {
	"use strict";
	var $, Animation, Lighter, __bind = function(fn, me) {
		return function() {
	...
	Lighter = (function() {
		...
		Lighter.prototype.defaults = {
			...
			template : "<div class='" + Lighter.namespace
					+ " fade'>\n  <div class='" + Lighter.namespace
					+ "-container'>\n    <span class='" + Lighter.namespace
					+ "-content'></span>\n    <a class='" + Lighter.namespace
					+ "-close'>&times;</a>\n    <a class='" + Lighter.namespace
					+ "-prev'>&lsaquo;</a>\n    <a class='" + Lighter.namespace
					+ "-next'>&rsaquo;</a>\n  </div>\n  <div class='"
		...
		Lighter.prototype.prev = function() {
			...
			return typeof event !== "undefined" && event !== null ? event
		...
		Lighter.prototype.type = function(href) {
			...
			return this.settings.type
					|| (this.href()
							.match(/\.(webp|jpeg|jpg|jpe|gif|png|bmp)$/i) ? "image"
							: void 0);
		};
		...
		Lighter.prototype.align = function() {
			...
			return this.$container.css({
				height : size.height,
				width : size.width,
				margin : "-" + (size.height / 2) + "px -" + (size.width / 2)
						+ "px"
			});
		};
		...
		Lighter.prototype.size = function() {
			var ratio;
			ratio = Math.max(this.dimensions.height
					/ ($(window).height() - this.settings.padding),
					this.dimensions.width
							/ ($(window).width() - this.settings.padding));
			return {
				width : ratio > 1.0 ? Math.round(this.dimensions.width / ratio)
						: this.dimensions.width,
				height : ratio > 1.0 ? Math.round(this.dimensions.height
						/ ratio) : this.dimensions.height
			};
		};
	...
	$.fn.extend({
		lighter : function(option) {
			...
			return this.each(function() {
				...
				$this = $(this);
				options = $.extend({}, $.fn.lighter.defaults,
