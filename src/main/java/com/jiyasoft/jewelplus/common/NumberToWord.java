...
public class NumberToWord extends JRDefaultScriptlet {
 ...
 {"",
  ...
  " Crore"
    ...
    public static String displayResult(String val){
    	...
    	if(stringVal.indexOf(".") != -1){
    		...
    		String valArr[] = stringVal.split("\\.");
    		
    		Integer firstVal = Integer.parseInt(valArr[0]);
    		Integer secondVal = Integer.parseInt(valArr[1]);
    	
    		String firstConv = convertNumberToWords(firstVal);
    		String secondConv = convertNumberToWords(secondVal);
    		   
    		if(secondConv !=""){
    		retVal = "Rupees"+firstConv+" and"+secondConv+" Paise only";
    		}else{
    			retVal = firstConv+" only";
    		}
    		
    	}else{
    		Integer firVal = Integer.parseInt(val.toString());
    		String firstConve = convertNumberToWords(firVal);
    		retVal = firstConve;
    	}
    ...
    public static String convertNumberToWords(Integer n) 
    {
        input=numToString(n);
        String converted=""; 
        int pos=1; 
   ...
   public static void main(String[] args) {
    	...
    	System.out.println(NumberToWord.displayResult("263.50"));    	
	}
