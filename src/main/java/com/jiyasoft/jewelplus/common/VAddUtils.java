  ...
  " Crore"
    ...
    public static String displayResult(String val){
    	...
    	if(stringVal.indexOf(".") != -1){
    		...
    		retVal = firstConv+" and "+secondConv+" cent only";
    		
    	}else{
    		Integer firVal = Integer.parseInt(val);
   ...
   /* public static void main(String[] args) {
    	...
    	System.out.println(VAddUtils.displayResult("160484.68"));
