...
@Entity
@Table(name = "quotexportexcel")
public class QuotExportExcel {
	...
	public String getSubShapeCode() {
		return subShapeCode;
	}



	public void setSubShapeCode(String subShapeCode) {
		this.subShapeCode = subShapeCode;
	}
