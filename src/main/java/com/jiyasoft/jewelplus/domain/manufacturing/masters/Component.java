...
public class Component {
	...
	@Column(name = "NotMetalFlg")
	private Boolean notMetalFlg = false;
	...
	public Boolean getNotMetalFlg() {
		return notMetalFlg;
	}

	public void setNotMetalFlg(Boolean notMetalFlg) {
		this.notMetalFlg = notMetalFlg;
	}
