...
public interface IStkTrfDtRepository extends JpaRepository<StkTrfDt,Integer>,QueryDslPredicateExecutor<StkTrfDt> {

	List<StkTrfDt> findByStkTrfMt(StkTrfMt stkTrfMt);
}
