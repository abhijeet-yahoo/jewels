...
/**
 * QExportExcel is a Querydsl query type for ExportExcel
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QExportExcel extends EntityPathBase<QuotExportExcel> {

    private static final long serialVersionUID = 1030342787L;

    public static final QExportExcel exportExcel = new QExportExcel("exportExcel");
    ...
    public QExportExcel(String variable) {
        super(QuotExportExcel.class, forVariable(variable));
    }

    public QExportExcel(Path<? extends QuotExportExcel> path) {
        super(path.getType(), path.getMetadata());
    }

    public QExportExcel(PathMetadata<?> metadata) {
