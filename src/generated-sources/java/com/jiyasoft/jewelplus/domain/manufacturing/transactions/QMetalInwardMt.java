...
/**
 * QMetalInwardMt is a Querydsl query type for MetalInwardMt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QMetalInwardMt extends EntityPathBase<MetalInwardMt> {

    private static final long serialVersionUID = -298294289L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMetalInwardMt metalInwardMt = new QMetalInwardMt("metalInwardMt");
    ...
    public QMetalInwardMt(String variable) {
        this(MetalInwardMt.class, forVariable(variable), INITS);
    }

    public QMetalInwardMt(Path<? extends MetalInwardMt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QMetalInwardMt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QMetalInwardMt(PathMetadata<?> metadata, PathInits inits) {
        this(MetalInwardMt.class, metadata, inits);
    }

    public QMetalInwardMt(Class<? extends MetalInwardMt> type, PathMetadata<?> metadata, PathInits inits) {
