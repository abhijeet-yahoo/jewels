...
/**
 * QJobIssMt is a Querydsl query type for JobIssMt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QJobIssMt extends EntityPathBase<JobIssMt> {

    private static final long serialVersionUID = -1921175245L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJobIssMt jobIssMt = new QJobIssMt("jobIssMt");
    ...
    public QJobIssMt(String variable) {
        this(JobIssMt.class, forVariable(variable), INITS);
    }

    public QJobIssMt(Path<? extends JobIssMt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobIssMt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobIssMt(PathMetadata<?> metadata, PathInits inits) {
        this(JobIssMt.class, metadata, inits);
    }

    public QJobIssMt(Class<? extends JobIssMt> type, PathMetadata<?> metadata, PathInits inits) {
