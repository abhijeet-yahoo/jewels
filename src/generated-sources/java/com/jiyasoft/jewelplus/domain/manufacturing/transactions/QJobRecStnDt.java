...
/**
 * QJobRecStnDt is a Querydsl query type for JobRecStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QJobRecStnDt extends EntityPathBase<JobRecStnDt> {

    private static final long serialVersionUID = -484680470L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJobRecStnDt jobRecStnDt = new QJobRecStnDt("jobRecStnDt");
    ...
    public final BooleanPath manualFlg = createBoolean("manualFlg");
    ...
    public QJobRecStnDt(String variable) {
        this(JobRecStnDt.class, forVariable(variable), INITS);
    }

    public QJobRecStnDt(Path<? extends JobRecStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobRecStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobRecStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(JobRecStnDt.class, metadata, inits);
    }

    public QJobRecStnDt(Class<? extends JobRecStnDt> type, PathMetadata<?> metadata, PathInits inits) {
