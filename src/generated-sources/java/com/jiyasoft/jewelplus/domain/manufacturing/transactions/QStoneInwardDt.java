...
/**
 * QStoneInwardDt is a Querydsl query type for StoneInwardDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QStoneInwardDt extends EntityPathBase<StoneInwardDt> {

    private static final long serialVersionUID = 1779921462L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QStoneInwardDt stoneInwardDt = new QStoneInwardDt("stoneInwardDt");
    ...
    public final QStoneInwardMt stoneInwardMt;
    ...
    public QStoneInwardDt(String variable) {
        this(StoneInwardDt.class, forVariable(variable), INITS);
    }

    public QStoneInwardDt(Path<? extends StoneInwardDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStoneInwardDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStoneInwardDt(PathMetadata<?> metadata, PathInits inits) {
        this(StoneInwardDt.class, metadata, inits);
    }

    public QStoneInwardDt(Class<? extends StoneInwardDt> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.stoneInwardMt = inits.isInitialized("stoneInwardMt") ? new QStoneInwardMt(forProperty("stoneInwardMt"), inits.get("stoneInwardMt")) : null;
