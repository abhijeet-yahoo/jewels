...
/**
 * QRepairRetStnDt is a Querydsl query type for RepairRetStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QRepairRetStnDt extends EntityPathBase<RepairRetStnDt> {

    private static final long serialVersionUID = 258592009L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRepairRetStnDt repairRetStnDt = new QRepairRetStnDt("repairRetStnDt");
    ...
    public QRepairRetStnDt(String variable) {
        this(RepairRetStnDt.class, forVariable(variable), INITS);
    }

    public QRepairRetStnDt(Path<? extends RepairRetStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QRepairRetStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QRepairRetStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(RepairRetStnDt.class, metadata, inits);
    }

    public QRepairRetStnDt(Class<? extends RepairRetStnDt> type, PathMetadata<?> metadata, PathInits inits) {
