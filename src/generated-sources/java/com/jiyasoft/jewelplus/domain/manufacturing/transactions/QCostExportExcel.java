...
/**
 * QCostExportExcel is a Querydsl query type for CostExportExcel
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QCostExportExcel extends EntityPathBase<CostExportExcel> {

    private static final long serialVersionUID = -827769226L;

    public static final QCostExportExcel costExportExcel = new QCostExportExcel("costExportExcel");
    ...
    public QCostExportExcel(String variable) {
        super(CostExportExcel.class, forVariable(variable));
    }

    public QCostExportExcel(Path<? extends CostExportExcel> path) {
        super(path.getType(), path.getMetadata());
    }

    public QCostExportExcel(PathMetadata<?> metadata) {
        super(CostExportExcel.class, metadata);
    }
