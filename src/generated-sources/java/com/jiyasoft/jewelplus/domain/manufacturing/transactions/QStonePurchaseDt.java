...
/**
 * QStonePurchaseDt is a Querydsl query type for StonePurchaseDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QStonePurchaseDt extends EntityPathBase<StonePurchaseDt> {

    private static final long serialVersionUID = 1327883478L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QStonePurchaseDt stonePurchaseDt = new QStonePurchaseDt("stonePurchaseDt");
    ...
    public final QStonePurchaseMt stonePurchaseMt;
    ...
    public QStonePurchaseDt(String variable) {
        this(StonePurchaseDt.class, forVariable(variable), INITS);
    }

    public QStonePurchaseDt(Path<? extends StonePurchaseDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStonePurchaseDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStonePurchaseDt(PathMetadata<?> metadata, PathInits inits) {
        this(StonePurchaseDt.class, metadata, inits);
    }

    public QStonePurchaseDt(Class<? extends StonePurchaseDt> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.stonePurchaseMt = inits.isInitialized("stonePurchaseMt") ? new QStonePurchaseMt(forProperty("stonePurchaseMt"), inits.get("stonePurchaseMt")) : null;
