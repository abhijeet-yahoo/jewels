...
/**
 * QVAddStnDt is a Querydsl query type for VAddStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QVAddStnDt extends EntityPathBase<VAddStnDt> {

    private static final long serialVersionUID = 17130290L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QVAddStnDt vAddStnDt = new QVAddStnDt("vAddStnDt");
    ...
    public final NumberPath<Double> loanCarat = createNumber("loanCarat", Double.class);

    public final NumberPath<Double> loanValue = createNumber("loanValue", Double.class);
    ...
    public QVAddStnDt(String variable) {
        this(VAddStnDt.class, forVariable(variable), INITS);
    }

    public QVAddStnDt(Path<? extends VAddStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QVAddStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QVAddStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(VAddStnDt.class, metadata, inits);
    }

    public QVAddStnDt(Class<? extends VAddStnDt> type, PathMetadata<?> metadata, PathInits inits) {
