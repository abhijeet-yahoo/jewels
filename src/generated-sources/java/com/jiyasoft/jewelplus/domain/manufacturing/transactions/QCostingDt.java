...
/**
 * QCostingDt is a Querydsl query type for CostingDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QCostingDt extends EntityPathBase<CostingDt> {

    private static final long serialVersionUID = -530224763L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCostingDt costingDt = new QCostingDt("costingDt");
    ...
    public QCostingDt(String variable) {
        this(CostingDt.class, forVariable(variable), INITS);
    }

    public QCostingDt(Path<? extends CostingDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCostingDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCostingDt(PathMetadata<?> metadata, PathInits inits) {
        this(CostingDt.class, metadata, inits);
    }

    public QCostingDt(Class<? extends CostingDt> type, PathMetadata<?> metadata, PathInits inits) {
