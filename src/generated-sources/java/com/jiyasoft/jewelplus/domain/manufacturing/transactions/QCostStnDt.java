...
/**
 * QCostStnDt is a Querydsl query type for CostStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QCostStnDt extends EntityPathBase<CostStnDt> {

    private static final long serialVersionUID = -550356752L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCostStnDt costStnDt = new QCostStnDt("costStnDt");
    ...
    public QCostStnDt(String variable) {
        this(CostStnDt.class, forVariable(variable), INITS);
    }

    public QCostStnDt(Path<? extends CostStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCostStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCostStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(CostStnDt.class, metadata, inits);
    }

    public QCostStnDt(Class<? extends CostStnDt> type, PathMetadata<?> metadata, PathInits inits) {
