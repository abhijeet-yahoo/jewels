...
/**
 * QJobIssCompDt is a Querydsl query type for JobIssCompDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QJobIssCompDt extends EntityPathBase<JobIssCompDt> {

    private static final long serialVersionUID = 724020619L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJobIssCompDt jobIssCompDt = new QJobIssCompDt("jobIssCompDt");
    ...
    public QJobIssCompDt(String variable) {
        this(JobIssCompDt.class, forVariable(variable), INITS);
    }

    public QJobIssCompDt(Path<? extends JobIssCompDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobIssCompDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QJobIssCompDt(PathMetadata<?> metadata, PathInits inits) {
        this(JobIssCompDt.class, metadata, inits);
    }

    public QJobIssCompDt(Class<? extends JobIssCompDt> type, PathMetadata<?> metadata, PathInits inits) {
