...
/**
 * QStnLooseDt is a Querydsl query type for StnLooseDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QStnLooseDt extends EntityPathBase<StnLooseDt> {

    private static final long serialVersionUID = 354875329L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QStnLooseDt stnLooseDt = new QStnLooseDt("stnLooseDt");
    ...
    public QStnLooseDt(String variable) {
        this(StnLooseDt.class, forVariable(variable), INITS);
    }

    public QStnLooseDt(Path<? extends StnLooseDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStnLooseDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QStnLooseDt(PathMetadata<?> metadata, PathInits inits) {
        this(StnLooseDt.class, metadata, inits);
    }

    public QStnLooseDt(Class<? extends StnLooseDt> type, PathMetadata<?> metadata, PathInits inits) {
