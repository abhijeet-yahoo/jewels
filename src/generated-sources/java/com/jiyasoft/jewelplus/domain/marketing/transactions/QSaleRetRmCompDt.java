...
/**
 * QSaleRetRmCompDt is a Querydsl query type for SaleRetRmCompDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QSaleRetRmCompDt extends EntityPathBase<SaleRetRmCompDt> {

    private static final long serialVersionUID = 1369070796L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSaleRetRmCompDt saleRetRmCompDt = new QSaleRetRmCompDt("saleRetRmCompDt");
    ...
    public QSaleRetRmCompDt(String variable) {
        this(SaleRetRmCompDt.class, forVariable(variable), INITS);
    }

    public QSaleRetRmCompDt(Path<? extends SaleRetRmCompDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRetRmCompDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRetRmCompDt(PathMetadata<?> metadata, PathInits inits) {
        this(SaleRetRmCompDt.class, metadata, inits);
    }

    public QSaleRetRmCompDt(Class<? extends SaleRetRmCompDt> type, PathMetadata<?> metadata, PathInits inits) {
