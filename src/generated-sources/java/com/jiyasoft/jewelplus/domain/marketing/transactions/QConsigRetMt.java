...
/**
 * QConsigRetMt is a Querydsl query type for ConsigRetMt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QConsigRetMt extends EntityPathBase<ConsigRetMt> {

    private static final long serialVersionUID = 641245457L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QConsigRetMt consigRetMt = new QConsigRetMt("consigRetMt");
    ...
    public QConsigRetMt(String variable) {
        this(ConsigRetMt.class, forVariable(variable), INITS);
    }

    public QConsigRetMt(Path<? extends ConsigRetMt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QConsigRetMt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QConsigRetMt(PathMetadata<?> metadata, PathInits inits) {
        this(ConsigRetMt.class, metadata, inits);
    }

    public QConsigRetMt(Class<? extends ConsigRetMt> type, PathMetadata<?> metadata, PathInits inits) {
