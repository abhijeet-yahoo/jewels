...
/**
 * QSaleRetRmStnDt is a Querydsl query type for SaleRetRmStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QSaleRetRmStnDt extends EntityPathBase<SaleRetRmStnDt> {

    private static final long serialVersionUID = 1860203824L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSaleRetRmStnDt saleRetRmStnDt = new QSaleRetRmStnDt("saleRetRmStnDt");
    ...
    public QSaleRetRmStnDt(String variable) {
        this(SaleRetRmStnDt.class, forVariable(variable), INITS);
    }

    public QSaleRetRmStnDt(Path<? extends SaleRetRmStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRetRmStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRetRmStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(SaleRetRmStnDt.class, metadata, inits);
    }

    public QSaleRetRmStnDt(Class<? extends SaleRetRmStnDt> type, PathMetadata<?> metadata, PathInits inits) {
