...
/**
 * QSaleRmCompDt is a Querydsl query type for SaleRmCompDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QSaleRmCompDt extends EntityPathBase<SaleRmCompDt> {

    private static final long serialVersionUID = -1036058423L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSaleRmCompDt saleRmCompDt = new QSaleRmCompDt("saleRmCompDt");
    ...
    public QSaleRmCompDt(String variable) {
        this(SaleRmCompDt.class, forVariable(variable), INITS);
    }

    public QSaleRmCompDt(Path<? extends SaleRmCompDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRmCompDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRmCompDt(PathMetadata<?> metadata, PathInits inits) {
        this(SaleRmCompDt.class, metadata, inits);
    }

    public QSaleRmCompDt(Class<? extends SaleRmCompDt> type, PathMetadata<?> metadata, PathInits inits) {
