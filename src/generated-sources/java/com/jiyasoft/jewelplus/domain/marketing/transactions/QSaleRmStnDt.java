...
/**
 * QSaleRmStnDt is a Querydsl query type for SaleRmStnDt
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QSaleRmStnDt extends EntityPathBase<SaleRmStnDt> {

    private static final long serialVersionUID = -1958158957L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSaleRmStnDt saleRmStnDt = new QSaleRmStnDt("saleRmStnDt");
    ...
    public QSaleRmStnDt(String variable) {
        this(SaleRmStnDt.class, forVariable(variable), INITS);
    }

    public QSaleRmStnDt(Path<? extends SaleRmStnDt> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRmStnDt(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QSaleRmStnDt(PathMetadata<?> metadata, PathInits inits) {
        this(SaleRmStnDt.class, metadata, inits);
    }

    public QSaleRmStnDt(Class<? extends SaleRmStnDt> type, PathMetadata<?> metadata, PathInits inits) {
